...
from inference_coreoneconv10146181localgparapoolperand import InferenceCore
...
test_dataset = DAVISTestDataset(davis_path, imset='/../val.txt', single_object=True)
test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=120, pin_memory=True)
