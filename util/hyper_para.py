...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        # Data parameters
        parser.add_argument('--static_root', help='Static training data root', default='/dataset/longma/STCN-main/dataset/static_data')
        parser.add_argument('--bl_root', help='Blender training data root', default='/dataset/BL30K')
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='/dataset/longma/STCN-main/dataset/Youtube-VOS')
        # parser.add_argument('--yv_root', help='YouTubeVOS data root', default='/dataset/longma/STCN-main/dataset/youtube2019/19')

        parser.add_argument('--davis_root', help='DAVIS data root', default='/dataset/longma/STCN-main/dataset/DAVIS/trainval')
        ...
        parser.add_argument('--num_workers', help='Number of datalaoder workers per process', type=int, default=110)
        ...
        if self.args['stage'] == 0:
            ...
            self.args['iterations'] = none_or_default(self.args['iterations'], 580000)
            ...
            self.args['lr'] = none_or_default(self.args['lr'], 1e-5)
            self.args['batch_size'] = none_or_default(self.args['batch_size'], 4)
            self.args['iterations'] = none_or_default(self.args['iterations'], 680000)
